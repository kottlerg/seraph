...
// usertest is an integration test harness; helpers panic on protocol
// violation so faults surface in the log. Matches main.rs's allow.
#![allow(clippy::expect_used, clippy::unwrap_used)]

use crate::ipc_util::ns::ns_lookup;

/// Walk the per-test `/usertest` directory from the std-overlay
/// root-dir cap and return the dir cap.
pub fn usertest_dir_cap(ipc_buf: *mut u64) -> u32
{
