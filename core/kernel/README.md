...
│       ├── mod.rs              # Dispatch table, entry coordination, sleep, IPC-buffer and notification-binding syscalls
...
│       └── thread.rs           # Thread lifecycle syscalls (configure, start, stop, priority, affinity, regs, fault handler)
└── docs/
