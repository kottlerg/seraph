...
pub struct ThreadControlBlock
{
    ...
    /// survives. Read out-of-band by `sys_cap_info`'s `CAP_INFO_THREAD_STATE`
    /// selector so userspace process managers can answer "did this thread die, and
    /// with what reason?" without racing the userspace death-event drain.
    pub exit_reason: u64,
