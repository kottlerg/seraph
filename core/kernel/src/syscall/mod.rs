...
use syscall::{
    ...
    SYS_CAP_INSERT, SYS_CAP_MOVE, SYS_CAP_REVOKE, SYS_EVENT_POST, SYS_EVENT_RECV, SYS_FRAME_MERGE,
    SYS_FRAME_SPLIT, SYS_IOPORT_BIND, SYS_IOPORT_SPLIT, SYS_IPC_BUFFER_SET, SYS_IPC_CALL,
