...
- **Address translation**: one of Sv39/Sv48/Sv57, negotiated at boot (DTB `mmu-type` plus a `satp` write-probe; the widest confirmed mode wins). Sv39 is the RVA23 mandatory minimum and the refusal floor; Sv48 is the standing default in CI and development.
...
- **Sv57** — a larger-VA expansion above the Sv48 default; used when the platform advertises and the probe confirms it.
