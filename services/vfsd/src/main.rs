...
fn main() -> !
{
    ...
    // resolving `/services/fatfs` before a worker spawns a fresh fatfs
...
pub struct VfsdRuntime
{
    ...
    /// (e.g. resolving `/services/fatfs`) before issuing
...
) -> Result<u32, u64>
{
    ...
    // and the spawn path walks vfsd's own system-root cap to /services/fatfs
