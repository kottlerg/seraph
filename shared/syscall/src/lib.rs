...
pub use syscall_abi::{
    ...
    CAP_INFO_FRAME_PHYS_BASE, CAP_INFO_FRAME_SIZE, CAP_INFO_TAG_RIGHTS, MAP_EXECUTABLE,
    MAP_READONLY, MAP_WRITABLE, RIGHTS_ALL, RIGHTS_CSPACE, RIGHTS_MAP_READ, RIGHTS_MAP_RW,
    RIGHTS_MAP_RX, RIGHTS_RECEIVE, RIGHTS_RETYPE, RIGHTS_SEND, RIGHTS_SEND_GRANT, RIGHTS_THREAD,
};
